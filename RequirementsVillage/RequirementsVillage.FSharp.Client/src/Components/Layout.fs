...
let view (model: Model) (dispatch: Msg -> unit) (content: ReactElement) =
    Html.div [
        ...
        prop.children [
            Html.div [
                prop.className "is-flex-grow-1 is-flex is-flex-direction-column"
                ...
                prop.children [
                    Html.header [
                        ...
                        prop.children [
                            Html.div [
                                prop.className "is-flex is-justify-content-space-between is-align-items-center"
                                prop.children [
                                    Html.div [
                                        Html.h1 [
                                            prop.className "title is-4"
                                            prop.style [ style.marginBottom (length.rem 0.25) ]
